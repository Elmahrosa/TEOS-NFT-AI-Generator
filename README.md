...
> **TEOS NFT AI Generator** is a full-stack platform for generating culturally inspired NFTs using AI.
>  Built with React + Flask, it supports multi-language prompts, Egyptian art styles, and is ready for blockchain minting (Solana, Ethereum).
>  Phase 1 is live.
>  Phase 2 (minting) launches September 2025.
